...
bool cmp1::operator()(const std::tuple<W,int>& t1, const std::tuple<W,int>& t2) const
{
...
bool cmp2::operator()(const std::tuple<W,W>& t1, const std::tuple<W,W>& t2)const{
    QVector<W> v1 = {std::get<0>(t1), std::get<1>(t1)};
    QVector<W> v2 = {std::get<0>(t2), std::get<1>(t2)};
    return compareWs(v1,v2);
}

bool cmp3::operator ()(const W& w1, const W& w2) const{
    QVector<W> v1 = {w1};
    QVector<W> v2 = {w2};
    return compareWs(v1,v2);
}
...
bool cmp4::operator ()(const container& c1, const container& c2) const{
